#' Create a regression task with interaction term order
#' @author Yong Kai Wong
#' @description Generating pairwise interaction terms of a data and pass in to a regression task 
#' 
...
modifiedMakeRegrTask <- function(data, target, order = 2, remove.constant = TRUE,...){
